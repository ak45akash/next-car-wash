    ...
    <div className="relative h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          priority
          className="object-cover brightness-[0.6] scale-110 hover:scale-105 transition-transform duration-10000"
          style={{
      ...
      {/* Animated Overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-900/40 to-black/30 z-0 animate-fadeInUp"></div>

      {/* Content */}
      <div className="container-custom relative z-10 text-white">
        <div className="max-w-2xl animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
          <h1 className="text-5xl font-bold mb-6 leading-tight">
            <span className="text-blue-400 animate-pulse">Diamond</span> Steam Car Wash in <span className="gradient-text">Mohali</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 animate-slideInFromBottom" style={{ animationDelay: '0.6s' }}>
      ...
      <div className="absolute bottom-12 left-0 right-0 z-10">
        <div className="container-custom">
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 animate-slideInFromBottom" style={{ animationDelay: '1s' }}>
